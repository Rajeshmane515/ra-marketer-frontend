...
const AccountMarketing = () => {
  ...
  return (
    <>
      <SEO
        title="Account Based Marketing Services | RA Marketer"
        description="RA Marketer provides account based marketing services that help B2B companies target high-value accounts, engage decision-makers, and generate qualified opportunities."
      />
      ...
      <PageContainer>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="mt-4 text-white/60">
                    Our ABM services help technology companies focus their
                    efforts on high-value accounts that have the strongest
        ...
        {/* SERVICES */}
        <div className="mt-32">
          <SectionHeading title="Account Based Marketing Services" />
